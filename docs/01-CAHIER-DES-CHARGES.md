...
8. **Les conférences et lives** — planifiés depuis le site, ou annoncés uniquement sur
   Discord ? La réponse décide si un objet « événement récurrent » manque au modèle.
...
(§3, étape 1). Le reste des recommandations de ce document — la proposition émise depuis
`/formateur`, l'absence de choix de produit avant l'audit, l'affectation explicite comme
périmètre du formateur — reste soumis à arbitrage.
