...
export const ECRANS: ReadonlyArray<Ecran> = [
  {
    ...
    questions: [
      { type: 'texte', champ: 'prenom', libelle: 'Quel est votre prénom ?' },
      { type: 'email', champ: 'email', libelle: 'Quelle est votre adresse email ?' },
      { type: 'tel', champ: 'telephone', libelle: 'Quel est votre numéro de téléphone ?' },
      {
        type: 'choix',
        champ: 'zone_geo',
        libelle: 'Dans quelle zone géographique êtes-vous basé(e) ?',
        options: ZONES_GEO,
      },
    ],
  },
    ...
    questions: [
      {
        type: 'choix',
        champ: 'situation_pro',
        libelle: 'Quelle est votre situation professionnelle ?',
        options: SITUATIONS_PRO,
      },
      {
        type: 'choix',
        champ: 'niveau_trading',
        libelle: 'Où en êtes-vous dans votre parcours trading ?',
    ...
    questions: [
      {
        type: 'choix',
        champ: 'prop_firm',
        libelle: 'Avez-vous une prop firm actuellement ?',
        options: PROP_FIRM,
      },
      {
        type: 'choix',
        champ: 'blocage',
        libelle: "Aujourd'hui, quel est votre plus gros blocage ?",
        options: BLOCAGES,
      },
      {
        type: 'choix',
        champ: 'tranche_budget',
        libelle: 'Quel budget êtes-vous prêt à investir dans votre parcours ?',
